...
expected_states = {
    SimpleSpanningTree.__name__: {
        "s1": {"s1-eth1": "forwarding", "s1-eth2": "forwarding", "s1-eth3": "forwarding"},
        "s2": {"s2-eth1": "blocking", "s2-eth2": "forwarding"},
        "s3": {"s3-eth1": "forwarding", "s3-eth2": "forwarding", "s3-eth3": "forwarding"},
    ...
    SpanningTreeAdjust.__name__: {
        "s1": {"s1-eth1": "forwarding", "s1-eth2": "forwarding", "s1-eth3": "forwarding", "s1-eth4": "forwarding"},
        "s2": {"s2-eth1": "forwarding", "s2-eth2": "blocking"},
        "s3": {"s3-eth1": "forwarding", "s3-eth2": "forwarding", "s3-eth3": "forwarding", "s3-eth4": "forwarding"},
        "s4": {"s4-eth1": "forwarding", "s4-eth2": "blocking"},
        "s5": {"s5-eth1": "forwarding", "s5-eth2": "blocking", "s5-eth3": "forwarding", "s5-eth4": "forwarding"},
        "s6": {"s6-eth1": "forwarding", "s6-eth2": "blocking"}
    },
    "SpanningTreeAdjust-mod": {
        "s1": {"s1-eth1": "forwarding", "s1-eth2": "forwarding", "s1-eth3": "forwarding", "s1-eth4": "forwarding"},
        "s2": {"s2-eth1": "blocking", "s2-eth2": "forwarding"},
        "s3": {"s3-eth1": "blocking", "s3-eth2": "forwarding", "s3-eth3": "forwarding", "s3-eth4": "forwarding"},
        "s4": {"s4-eth1": "blocking", "s4-eth2": "forwarding"},
        "s5": {"s5-eth1": "forwarding", "s5-eth2": "forwarding", "s5-eth3": "forwarding", "s5-eth4": "forwarding"},
    ...
    SpanningTreeFullMesh.__name__: {
        ...
        "s2": {"s2-eth1": "forwarding", "s2-eth2": "forwarding", "s2-eth3": "forwarding",
               "s2-eth4": "forwarding", "s2-eth5": "forwarding"},
        "s3": {"s3-eth1": "forwarding", "s3-eth2": "blocking", "s3-eth3": "forwarding",
               "s3-eth4": "forwarding", "s3-eth5": "forwarding"},
        "s4": {"s4-eth1": "forwarding", "s4-eth2": "blocking", "s4-eth3": "blocking",
    ...
    SpanningTreeHub.__name__: {
        "s3": {"s3-eth1": "forwarding", "s3-eth2": "forwarding", "s3-eth3": "forwarding"},
        "s6": {"s6-eth1": "forwarding", "s6-eth2": "forwarding", "s6-eth3": "forwarding"},
        "s10": {"s10-eth1": "forwarding", "s10-eth2": "forwarding"},
        "s11": {"s11-eth1": "blocking", "s11-eth2": "forwarding", "s11-eth3": "blocking"},
        "s12": {"s12-eth1": "forwarding", "s12-eth2": "blocking"},
    ...
    SpanningTreeIntermediate.__name__: {
        ...
        "s5": {"s5-eth1": "forwarding", "s5-eth2": "blocking", "s5-eth3": "blocking"},
        "s10": {"s10-eth1": "forwarding", "s10-eth2": "forwarding", "s10-eth3": "forwarding"}
    },
...
def test_stp_adjust():
    try:
        net = IPNet(topo=SpanningTreeAdjust(l1_start="s2-eth1", l1_end="s1-eth1", l1_cost=2,
                                            l2_start="s1-eth3", l2_end="s3-eth1", l2_cost=3))
        net.start()
