...
class BGPPoliciesTopo5(IPTopo):
    """This topology builds a 8-AS network exchanging BGP reachability as shown in the figure below
    ...
    This topology is taken from https://www.computer-networking.info/exercises/html/ex-bgp.html"""
